...
public class StartWindow extends JFrame {
	...
	private void createWindow() {
		...
		JLabel lblByRafidShaon = new JLabel("By: Rafid Shaon (2022)");
		lblByRafidShaon.setHorizontalAlignment(SwingConstants.CENTER);
		lblByRafidShaon.setBounds(6, 50, 438, 16);
		contentPane.add(lblByRafidShaon);
